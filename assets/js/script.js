...
(function($){
    ...
    if($("#googlemap").length > 0){
        ...
        var myOptions = {
            ...
            zoom: 15,
            center: new google.maps.LatLng(37.7731764, -122.4893758), //change the coordinates
        ...
        var marker = new google.maps.Marker({
                ...
                map: map,
                position: new google.maps.LatLng(37.7731764, -122.4893758)  //change the coordinates

        });

        var infowindow = new google.maps.InfoWindow({

                content: "<div style='color:#222'><b>Daniel Stapleton</b></div>"  //change your address
